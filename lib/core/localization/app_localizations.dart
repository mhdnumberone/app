...
const Map<String, Map<String, String>> _localizedStrings = {
  ...
  'ar': {
    ...
    // === Custom Guides ===
    'encryption_usage_guide_title': 'دليل الاستخدام',
    'encryption_usage_guide_button': 'إظهار/إخفاء دليل الاستخدام',
    'encryption_usage_guide_intro': 'قسم التشفير يتيح لك حماية رسائلك أو إخفائها داخل نصوص أخرى. اختر نمط العملية المناسب من القائمة المنسدلة، ثم أدخل البيانات المطلوبة.',
    'encryption_usage_guide_modes': 'شرح الأنماط المتاحة:',
    'encryption_mode_encrypt': 'تشفير: تحويل الرسالة إلى نص مشفر باستخدام كلمة مرور. لا يمكن قراءة الرسالة إلا بعد فك التشفير بنفس كلمة المرور.',
    'encryption_mode_decrypt': 'فك تشفير: إرجاع الرسالة المشفرة إلى نصها الأصلي باستخدام كلمة المرور الصحيحة.',
    'encryption_mode_hide': 'إخفاء: إخفاء رسالة سرية داخل نص غلاف باستخدام تقنية الإخفاء.',
    'encryption_mode_reveal': 'كشف: استخراج الرسالة المخفية من نص الغلاف.',
    'encryption_mode_encrypt_and_hide': 'تشفير وإخفاء: تشفير الرسالة أولاً ثم إخفاؤها داخل نص غلاف. حماية مزدوجة.',
    'encryption_mode_reveal_and_decrypt': 'كشف وفك تشفير: استخراج الرسالة المخفية من نص الغلاف ثم فك تشفيرها بكلمة المرور.',
    'encryption_usage_guide_steps': '- أدخل الرسالة أو النص المطلوب في الحقول المناسبة.\n- إذا كان النمط يتطلب كلمة مرور أو نص غلاف، ستظهر الحقول تلقائياً.\n- اضغط زر تنفيذ العملية للحصول على النتيجة.\n- استخدم زر "مسح" لمسح جميع الحقول.',
    // File Manager Guide
    'file_manager_guide_title': 'دليل إدارة الملفات',
    'file_manager_guide_button': 'إظهار/إخفاء دليل إدارة الملفات',
    'file_manager_guide_intro': 'قسم إدارة الملفات يتيح لك تصفح جميع الملفات والمجلدات على جهازك، وفتحها أو مشاركتها أو حذفها بسهولة.',
    'file_manager_guide_why': 'لماذا هذا القسم؟',
    'file_manager_guide_why_desc': '- يمنحك تحكمًا كاملاً في ملفاتك من مكان واحد داخل التطبيق.\n- يمكنك البحث، التصفح، فتح، مشاركة أو حذف أي ملف بسهولة وأمان.',
    'file_manager_guide_delete': 'ميزة الحذف:',
    'file_manager_guide_delete_desc': '- يمكنك حذف ملف أو عدة ملفات دفعة واحدة بشكل نهائي من جهازك.\n- الحذف مفيد لتوفير المساحة أو حماية الخصوصية.\n- انتبه: الملفات المحذوفة لا يمكن استعادتها من التطبيق.',
    'storage_permission_required': 'صلاحية التخزين مطلوبة',
    'view_permission_status': 'عرض حالة الصلاحية',
    ...
    'are_you_sure_delete_file': 'هل أنت متأكد أنك تريد حذف "{name}"?',
    'are_you_sure_delete_files': 'هل أنت متأكد أنك تريد حذف {count} ملف؟',
    'path_copied_to_clipboard': 'تم نسخ المسار إلى الحافظة',
    'cannot_open_file': 'لا يمكن فتح الملف: {message}',
    'error_opening_file': 'خطأ في فتح الملف: {message}',
    'error_sharing_files': 'خطأ في مشاركة الملفات: {message}',
    'create_new_file': 'إنشاء ملف جديد',
    'file_name': 'اسم الملف',
    'content': 'المحتوى',
    'enter_file_name': 'أدخل اسم الملف (مثال: notes.txt)',
    'enter_file_content': 'أدخل محتوى الملف (اختياري)',
    'properties': 'الخصائص',
    'extension': 'الامتداد',
    'type': 'النوع',
    'modified': 'آخر تعديل',
