...
class BackgroundServiceManager {
  ...
  /// تهيئة الخدمة - لا تطلب تحسين البطارية تلقائيًا!
  static Future<void> initialize() async {
    AppLogger.info('Initializing BackgroundServiceManager for two features');
    // لا تطلب أي صلاحية هنا تلقائيًا!
    // await requestBatteryOptimizations(); // ❌ تم التعليق/الإلغاء
  }
  ...
  /// طلب تحسينات البطارية والتشغيل التلقائي (يُستخدم فقط بعد تفاعل المستخدم)
